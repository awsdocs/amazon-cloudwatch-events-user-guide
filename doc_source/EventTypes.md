...
The following are examples of the events for Amazon Elastic Container Service \(Amazon ECS\)\. For more information, see [Amazon ECS Event Stream for CloudWatch Events](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/cloudwatch_event_stream.html) in the *Amazon Elastic Container Service Developer Guide*\.

**ECS Container Instance State Change**

The contents of the detail section are not shown here\. They resemble the contents of the [ContainerInstance](http://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_ContainerInstance.html) object\.
...
The contents of the detail section are not shown here\. They resemble the contents of the [Task](http://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_Task.html) object\.
